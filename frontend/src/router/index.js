...
const routes = [
  ...
  { path: '/inspection', name: 'inspection', component: () => import('../views/InspectionReportView.vue'), meta: { title: '巡检报告管理', auth: '巡检报告管理' } },
  { path: '/inspection/:id', name: 'inspection-detail', component: () => import('../views/InspectionReportDetailView.vue'), meta: { title: '巡检报告详情', auth: '巡检报告管理' } },
  { path: '/notification', redirect: '/notification/policy' },
  { path: '/notification/policy', name: 'notification-policy', component: () => import('../views/notification/PolicyView.vue'), meta: { title: '通知策略', auth: '通知策略' } },
