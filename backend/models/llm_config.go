...
type LLMConfig struct {
	...
	Model            string         `gorm:"size:50;comment:模型名称" json:"model"`
	BaseURL          string         `gorm:"size:200;comment:api url" json:"base_url"`
	APIKey           string         `gorm:"size:512;comment:密钥（AES-256-GCM 加密存储，enc:v1: 前缀）" json:"api_key"`
