...
export { cache as H, compare as J, defaultConfig as L, mutate as N, preload as O, unload as Q, SWRConfig$1 as S, useSWRConfig as T, SWRConfig as V, useSWR as X, unstable_serialize as u };
export type { Arguments as A, BareFetcher as B, CacheData as C, StateDependencies as D, UnloadOptions as E, FetcherResponse as F, GlobalState as G, InternalConfiguration as I, Key as K, Middleware as M, ProviderConfiguration as P, RevalidateCallback as R, Unloader as U, SWRGlobalConfig as W, SWRHook as a, SWRConfigValue as b, SWRResponse as c, MutatorCallback as d, SWRConfiguration as e, StrictTupleKey as f, MutatorOptions as g, Cache as h, ScopedMutator as i, State as j, FullConfiguration as k, Fetcher as l, BlockingData as m, Broadcaster as n, IsLoadingResponse as o, KeyLoader as p, KeyedMutator as q, Mutator as r, MutatorConfig as s, MutatorFn as t, MutatorWrapper as v, PublicConfiguration as w, RevalidateEvent as x, Revalidator as y, RevalidatorOptions as z };
