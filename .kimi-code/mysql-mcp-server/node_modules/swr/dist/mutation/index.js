...
const startTransition = bunchee_group_0.IS_REACT_LEGACY ? (cb)=>{
    cb();
...
const mutation = ()=>(key, fetcher, config = {})=>{
        const { mutate } = _internal_index.useSWRConfig();
        ...
        const [stateRef, stateDependencies, setState] = useStateWithDeps({
            data: bunchee_group_0.UNDEFINED,
            error: bunchee_group_0.UNDEFINED,
            isMutating: false
        });
        const currentState = stateRef.current;
        const trigger = React.useCallback(async (arg, opts)=>{
            const [serializedKey, resolvedKey] = bunchee_group_0.serialize(keyRef.current);
            ...
            const options = bunchee_group_0.mergeObjects(bunchee_group_0.mergeObjects({
                populateCache: false,
                throwOnError: true
            }, configRef.current), opts);
            // Trigger a mutation, and also track the timestamp. Any mutation that happened
            // earlier this timestamp should be ignored.
            const mutationStartedAt = bunchee_group_0.getTimestamp();
            ...
            try {
                ...
                bunchee_group_0.mergeObjects(options, {
                    throwOnError: true
                }));
        ...
        const reset = React.useCallback(()=>{
            ditchMutationsUntilRef.current = bunchee_group_0.getTimestamp();
            setState({
                data: bunchee_group_0.UNDEFINED,
                error: bunchee_group_0.UNDEFINED,
                isMutating: false
 ...
 * ```
 */ const useSWRMutation = _internal_index.withMiddleware(useSwr.useSWR, mutation);
