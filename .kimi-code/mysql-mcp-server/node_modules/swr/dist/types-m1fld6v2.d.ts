...
import { F as FOCUS_EVENT, R as RECONNECT_EVENT, M as MUTATE_EVENT, E as ERROR_REVALIDATE_EVENT, U as UNLOAD_EVENT } from './events-ny18dyc2.js';
import { dequal } from 'dequal/lite';

declare const SWRConfig$1: FC<PropsWithChildren<{
 ...
 * @public
 */
type Unloader = (options?: UnloadOptions) => void;
/**
...
type SWRConfigValue<Data = any, Error = any, Fn extends BareFetcher<any> = BareFetcher<any>> = Omit<SWRConfiguration<Data, Error, Fn>, 'cacheData'> & {
    /**
     * server-loaded data to be consumed by client hooks and written into cache
     * @experimental
     */
...
type RevalidateEvent = typeof FOCUS_EVENT | typeof RECONNECT_EVENT | typeof MUTATE_EVENT | typeof ERROR_REVALIDATE_EVENT | typeof UNLOAD_EVENT;
...
export { cache as E, compare as H, defaultConfig as J, mutate as L, preload as N, unload as O, useSWRConfig as Q, SWRConfig$1 as S, SWRConfig as T, useSWR as W, unstable_serialize as X };
export type { Arguments as A, BareFetcher as B, CacheData as C, UnloadOptions as D, FetcherResponse as F, GlobalState as G, InternalConfiguration as I, Key as K, MutatorCallback as M, ProviderConfiguration as P, RevalidateCallback as R, Unloader as U, SWRGlobalConfig as V, Cache as a, ScopedMutator as b, State as c, FullConfiguration as d, MutatorOptions as e, Fetcher as f, SWRConfiguration as g, SWRHook as h, Middleware as i, BlockingData as j, Broadcaster as k, IsLoadingResponse as l, KeyLoader as m, KeyedMutator as n, Mutator as o, MutatorConfig as p, MutatorFn as q, MutatorWrapper as r, PublicConfiguration as s, RevalidateEvent as t, Revalidator as u, RevalidatorOptions as v, SWRConfigValue as w, SWRResponse as x, StateDependencies as y, StrictTupleKey as z };
